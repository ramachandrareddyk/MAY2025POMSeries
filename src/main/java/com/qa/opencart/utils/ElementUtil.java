...
public class ElementUtil {
	...
	/*
	 * public boolean doSearch(By searchField, By suggestions, String searchKey,
	 * String matchValue) throws InterruptedException {
	 * 
	 * boolean flag = false;
	 * 
	 * doSendKeys(searchField, searchKey); Thread.sleep(3000);
	 * 
	 * List<WebElement> suggList = getElements(suggestions); int totalSuggestions =
	 * suggList.size(); System.out.println("Total number of suggestions===" +
	 * totalSuggestions);
	 * 
	 * if (totalSuggestions == 0) { System.out.println("No suggesstions found...");
	 * throw new FrameworkException("No Suggestions FOUND"); }
	 * 
	 * for (WebElement e : suggList) { String text = e.getText(); if
	 * (text.contains(matchValue)) { e.click(); flag = true; break; } }
	 * 
	 * if (flag) { System.out.println(matchValue + " is found"); return true; } else
	 * { System.out.println(matchValue + " is not found"); return false; }
	 * 
	 * }
	 */
